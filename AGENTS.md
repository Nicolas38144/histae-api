...
- PostgreSQL ne conserve jamais une URL photo externe ou signée : uniquement une clé `profile-photos/<user_uuid>/photo.webp`. Les réponses publiques produisent une URL signée courte au dernier moment.
...
- Après cette baseline, ajouter une migration incrémentale pour toute évolution persistante. Ne pas modifier ses sources après déploiement sans stratégie explicite de checksum et de compatibilité.
...
Au 1er septembre 2026, lint, typecheck, build, les 45 suites/268 cas autonomes et les 3 suites/40 cas d'intégration réels sont verts, soit 48 suites et 308 cas. La baseline consolidée a été enregistrée sans destruction sur `histae-dev` et appliquée dans un schéma temporaire vide. SeaweedFS avait également passé son healthcheck Docker et un aller-retour S3 écriture/lecture/suppression. Réexécuter les contrôles après toute modification.
