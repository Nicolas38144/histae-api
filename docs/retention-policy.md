...
l’anonymisation, afin qu’une réponse perdue ne fasse pas disparaître une référence à nettoyer. À 23 heures, un
watchdog durable remplace tout nouveau `POST` par des lectures de réconciliation ; l’intention bloque la clôture
